<template>
  <div>
    <b-sidebar
      ...
      no-header
      right
      :visible="unitAddSidebarActive"
      @change="(val) => $emit('update:unit-add-sidebar-active', val)"
    >
...
export default {
  ...
  model: {
    prop: 'unitAddSidebarActive',
    event: 'update:unit-add-sidebar-active',
  },
  props: {
    unitAddSidebarActive: {
      type: Boolean,
      required: true,
    },
  },
